...
from research_and_analysis.workflows.report_generator_workflow import AutonomousReportGenerator
...
class ReportService:
    ...
    def start_report_generation(self, topic: str, max_analysts: int):
        ...
        try:
            ...
            return {"thread_id": thread_id, "message": "Pipeline initiated sucessfully."}
