...
class AutonomousReportGenerator:
    ...
    def create_analyst(self, state: GenerateAnalystsState):
        ...
        system_messages = analyst_instructions.format(topic=topic, max_analysts=max_analysts, 
    ...
    def save_report(self, final_report: str, topic: str, format: str = "docx", save_dir: str = None):
        ...
        #sanitizing topic for windows filesystem
        ...
        if format == "docx":
            ...
            raise ValueError(f"Unsupported format: {format}. Use 'docx' or 'pdf'.")
    ...
    def _save_as_docx(self, text: str, file_path: str):
        """
        Formatting report into docx with markdown parsing for headers. 
    ...
    def build_graph(self):
        ...
        def initiate_all_interviews(state: ResearchGraphState):
            ...
            if not analysts:
                print("No analysts generated - skipping interviews.")
                return END
            #create on Send() event per analyst to trigger parallel interviews
            return [
                Send(
                    "conduct_interview",
                    {
