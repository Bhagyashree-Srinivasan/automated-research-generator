...
from research_and_analysis.logger import GLOBAL_LOGGER
...
class InterviewGraphBuilder:
    ...
    def __init__(self, llm, tavily_search):
        ...
        Args:
            llm: llm model
            tavily_search: tavily search instance
        """
        self.llm = llm
    ...
    #Analyst generates questions
    def _generate_question(self, state: InterviewState):
        """
        Generate the first question for the interview based on analyst's persona.
        """
        ...
        try:
            ...
            raise ResearchAnalystException(f"Failed to generate question: {str(e)}")
        
    #Performing relevant web search
    ...
    #Writing a report section based on the interview
